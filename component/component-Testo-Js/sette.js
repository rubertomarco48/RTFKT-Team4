...
function img() {
  if (!document.getElementById("img_new")) {
    ...
    imag.src = i[6].attributes.imghover.nodeValue;
    imag.setAttribute("style","width:200px ; position : fixed;border-radius:1rem;z-index=10")
    i[6].appendChild(imag);
    i[6].addEventListener("mousemove", (e) => {
...
i[6].addEventListener("mouseenter", img);
i[6].addEventListener("mouseout", () => {
