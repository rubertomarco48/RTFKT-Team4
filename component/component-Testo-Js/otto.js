...
function img() {
  if (!document.getElementById("img_new")) {
    ...
    imag.src = i[7].attributes.imghover.nodeValue;
    imag.setAttribute("style","width:200px ; position : fixed;border-radius:1rem;z-index=10")
    i[7].appendChild(imag);
    i[7].addEventListener("mousemove", (e) => {
...
i[7].addEventListener("mouseenter", img);
i[7].addEventListener("mouseout", () => {
